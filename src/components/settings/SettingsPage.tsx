...
export const SettingsPage: React.FC = () => {
  const { user, updateProfile, theme, setTheme, resetToDefaultData, showToast } = useApp();
      ...
      <div className="p-6 rounded-3xl bg-white dark:bg-[#0B1017] border border-slate-200/80 dark:border-[#1E293B] shadow-xs space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-2">
          <div>
            ...
            <p className="text-[11px] text-slate-400">All student data is saved automatically to your device.</p>
          </div>
          ...
          <button
            ...
            className="px-4 py-2.5 rounded-2xl bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 text-rose-700 dark:text-rose-300 text-xs font-bold transition flex items-center gap-2 cursor-pointer"
          >
